...
// Updated: Favorites added to Browse group

import { useTheme } from "../context/ThemeContext";
import { IconDownload, IconLibrary, IconSettings, IconSun, IconMoon, IconFolder, IconHeart } from "./Icons";
...
export type Page = "downloader" | "library" | "storage" | "anime" | "manga" | "movies" | "series" | "favorites" | "settings";

interface Props { page: Page; setPage: (p: Page) => void; activeDownloads: number; backendOk: boolean; }
